...
require_once(BLADE_DIR . '/View.php');
require_once(BLADE_DIR . '/ViewFinderInterface.php');
require_once(BLADE_DIR . '/Engines/EngineInterface.php');

use InvalidArgumentException;
use Blade\ViewFinderInterface;
