...
function transformFileWithSpriteSheetData(base, vinylFile, coordinateMap, pathToSpriteSheetFromCSS,  /*optional*/includeMode, /*optional*/isSilent, /*optional*/outputIndent) {
	...
	if(resultantFile) {
		...
		styles = mapOverStylesAndTransformBackgroundImageDeclarations(styles, includeMode, function(declaration) {
			...
			declaration.value = spriterUtil.matchBackgroundImages(declaration.value, function(imagePath) {
				...
				var coords = coordinateMap[path.join(base, imagePath)];
